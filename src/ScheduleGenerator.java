...
public class ScheduleGenerator {
    ...
    public ArrayList<Course> generateSchedule(Student student, List<Course> desiredCourses, HashMap<String, Course> allCourses) {
        ...
        for (Course randomCourse : availableCoursesList) {
    ...
    private boolean isVarsity(Course course) {
        if (course.getName() != null && course.getName().toLowerCase().contains("varsity") || course.getName() != null && course.getName().toLowerCase().contains("senior") || course.getName() != null && course.getName().toLowerCase().contains("first-year")) {
            return true;
        }
